                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <form class="d-flex me-5">
                                <!-- <input class="form-control text-white me-5" type="search" placeholder="Search" aria-label="Search">
                            <button class=" btn-icon" type="submit"><img class="img-icon-search" src="/assets/img/search-svgrepo-com 1.png" alt=""></button> -->
                                ...
                                <a href="{{ route('login-dosen') }}"
                                    class="py-2 px-4 btn text-white btn-outline-primary me-3">Dosen</a>
                                <a href="{{ route('login-admin') }}"
                                    class="py-2 px-4 btn text-white btn-outline-primary">Admin</a>
                            </form>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="tab-pane fade" id="dosen-login" role="tabpanel"
                                aria-labelledby="dosen-login-tab">.
                                <div class="card border bg-transparent text-white">
                                    @if (session()->has('success'))
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            {{ session('success') }}
